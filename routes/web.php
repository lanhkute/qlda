...
Route::group([
    ...
    Route::post('/admin/change-pw', [authAdminController::class, 'changePw'])->name('admin.processing.change-pw');
...
Route::group([
    ...
    Route::post('/khoa-hoc/ma-{course_id}/delete-danh-gia', [homeViewController::class, 'deleteRatingCourse'])->name('home.deleteRatingCourse');
...
Route::post('/reset-password', [homeViewController::class , 'resetPassword'])->name('user.resetPassword');
